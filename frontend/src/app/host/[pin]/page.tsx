      ...
      <div className="glass-panel flex flex-col items-center w-full max-w-6xl gap-12 shadow-2xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full gap-8 md:gap-0">
          <div className="flex flex-col gap-4 w-full text-center md:text-left items-center md:items-start">
            ...
            {joinUrl && (
              <div className="flex items-center gap-4 bg-[rgba(0,0,0,0.3)] px-8 py-4 md:px-12 md:py-4 rounded-2xl border border-white/10 w-fit mx-auto md:mx-0 mt-4 shadow-inner">
                ...
                <button 
                  ...
                  className="bg-[rgba(255,255,255,0.1)] hover:bg-[rgba(255,255,255,0.2)] px-8 py-3 md:px-10 md:py-4 rounded-xl text-base md:text-lg font-bold transition-all whitespace-nowrap shadow-md active:scale-95 ml-2 md:ml-4"
                >
